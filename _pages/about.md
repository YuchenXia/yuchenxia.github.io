...
- Integrating Visual Large Language Models for Anomaly Recognition in Manufacturing Systems (Master Thesis <a href="/files/student_theses/LLM_image_analysis.pdf" target="_blank">[Slides (PDF)]</a>)  
...
- Anomaly Detection and Analysis Using Simulated and Real-Time Video Data with Vision Language Models (Master Thesis <a href="/files/student_theses/LLM_Anomaly_Detection.pdf" target="_blank">[Slides (PDF)]</a>)  
- Fine-Tuning LLMs for AI-Assisted Compliance Analysis in Manufacturing (Master Thesis <a href="/files/student_theses/AI_assisted_document_editing.pdf" target="_blank">[Slides (PDF)]</a>)  
