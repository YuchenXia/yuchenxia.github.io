...
### 2025 (ongoing)
- [46] Adaptive Tool Selection via State Modeling for LLM Agents in Task Automation (Master Thesis)
- [45] Secure Task Delegation for Tool-Using Language Model Agents in Workflow Automation (Master Thesis)
- [44] Enhancing LLM Interpretability for time series with Algorithmic Feature Extraction (Master Thesis)
- [43] Resource-Constrained Optimization for On-Premise Deployment of LLM Applications (Master Thesis) 
- [42] Integrating Vision-Language Models and Object Recognition for Image Analysis in Manufacturing Systems (Master Thesis <a href="/files/student_theses/LLM_image_analysis.pdf" target="_blank">[Slides (PDF)]</a>) 
- [41] Design and Implementation of an LLM-Powered GUI Agent System for Automated Interface Interaction (Master Thesis <a href="/files/student_theses/LLM_Powered_GUI.pdf" target="_blank">[Slides (PDF)]</a>) 
- [40] Vision-Language ModelBased Anomaly Detection and Analysis Using Simulated and Camera Data (Master Thesis <a href="/files/student_theses/LLM_Anomaly_Detection.pdf" target="_blank">[Slides (PDF)]</a>) 
- [39] Large Language Model Agents for AI-Assisted Document Editing for Manufacturing Process Compliance (Master Thesis <a href="/files/student_theses/AI_assisted_document_editing.pdf" target="_blank">[Slides (PDF)]</a>) 
- [38] Optimizing LLM Interaction with Domain-Specific Simulation via Model Fine-Tuning (Master Thesis <a href="/files/student_theses/LLM_interaction_with_simulation.pdf" target="_blank">[Slides (PDF)]</a>)
- [37] Information Extraction with LLM Agents and Code Generation based on a Model-Driven Software Platform (Master Thesis <a href="/files/student_theses/Text_Classification_using.pdf" target="_blank">[Slides (PDF)]</a>)  
- [36] Scalable Graph-RAG-based Knowledge System for Domain-Specific Workflow Automation with LLMs (Master Thesis <a href="/files/student_theses/Scalable_GraphRAG.pdf" target="_blank">[Slides (PDF)]</a>)  
- [35] Synthetic Data Creation for Training LLMs on Domain-Specific Knowledge (Master Thesis <a href="/files/student_theses/synthetic_data_creation.pdf" target="_blank">[Slides (PDF)]</a>)   
- [34] Training LLMs on a Domain-Specific Knowledge Base with Reinforcement Learning (Master Thesis <a href="/files/student_theses/Training_LLMs_on_domain_specific.pdf" target="_blank">[Slides (PDF)]</a>)  
- [33] Development of a Simulation Platform with LLM Integration for Intelligent Manufacturing (Master Thesis <a href="/files/student_theses/Development_of_a_Simulation.pdf" target="_blank">[Slides (PDF)]</a>)  

### 2024
- [32] LLM-Powered Automation of Robotic Tasks in Warehouse Systems (Research Project <a href="/files/student_theses/LLM_Powered_Automation.pdf" target="_blank">[Slides (PDF)]</a>)  
- [31] Investigation of Textual Representation Methods for Improved Data Interpretation by LLMs in Engineering (Master Thesis <a href="/files/student_theses/Investigation_of_Textual_Representation.pdf" target="_blank">[Slides (PDF)]</a>)  
- [30] A Comprehensive Benchmark System for Evaluating LLM Performance in Industrial Automation (Master Thesis <a href="/files/student_theses/A_Comprehensive_Benchmark_System.pdf" target="_blank">[Slides (PDF)]</a>)  
- [29] Evaluating PDDL-Based and LLM-Based Task Planning of Robot Behavior for Production Processes (Research Project <a href="/files/student_theses/PDDL_LLM.pdf" target="_blank">[Slides (PDF)]</a>)  
- [28] Automating Safety and Risk Management with LLM Agents (Master Thesis <a href="/files/student_theses/Automating_Safety_and_Risk_Management.pdf" target="_blank">[Slides (PDF)]</a>)  
- [27] Fine-Tuning LLMs for Enhanced Semantic Interpretation of Microservices in Automation Systems (Research Project <a href="/files/student_theses/Fine-tuning_of_Large_Language_Models.pdf" target="_blank">[Slides (PDF)]</a>)  
- [26] Transforming Vehicle User Manuals into an Interactive AI Chatbot Powered by LLMs (Research Project <a href="/files/student_theses/Transforming_Vehicle_User_Manuals.pdf" target="_blank">[Slides (PDF)]</a>)  
- [25] Synthetic Training Data Creation for Supervised Fine-Tuning of LLMs for Autonomous Production Planning (Master Thesis <a href="/files/student_theses/Synthetic_training_data_creation.pdf" target="_blank">[Slides (PDF)]</a>)  
- [24] Integrating LLM Agents with Embedded Systems for Smart Oven Control (Master Thesis <a href="/files/student_theses/Integrating_Large_Language_Model_Agents.pdf" target="_blank">[Slides (PDF)]</a>)  
- [23] Survey on LLMs for Applications in Industrial Automation and Software Engineering (Research Project <a href="/files/student_theses/Survey_on_Large_Language_Models.pdf" target="_blank">[Slides (PDF)]</a>)  

### 2023
- [22] Large Language Models for OPC UA Server Data Retrieval (Research Project <a href="/files/student_theses/Large_Language_Models_for_OPC_UA.pdf" target="_blank">[Slides (PDF)]</a>)  
- [21] Generation of Simscape Models Using Large Language Models (Bachelor Thesis)  
- [20] Refining Automation Systems for Enhanced Modular Control (Master Thesis <a href="/files/student_theses/Refining_Automation_Systems.pdf" target="_blank">[Slides (PDF)]</a>)  
- [19] Interpretability Study of LLMs with Probing Techniques (Research Project <a href="/files/student_theses/Interpretability_Study.pdf" target="_blank">[Slides (PDF)]</a>)  
- [18] Evaluation of Quantized LLMs for Semantic Interpretation and Reasoning in Industrial Automation (Research Project <a href="/files/student_theses/Evaluation_of_Quantized.pdf" target="_blank">[Slides (PDF)]</a>)
- [17] Prompt Optimization with a Dual GPT-Agent Feedback System (Research Project <a href="/files/student_theses/Prompt_Optimization.pdf" target="_blank">[Slides (PDF)]</a>)  
- [16] Automated Test Scenario Generation for Autonomous Driving from Accident Reports (Research Project <a href="/files/student_theses/Automated_Test_Scenario_Generation.pdf" target="_blank">[Slides (PDF)]</a>)  
- [15] Investigation of the Explainability of LLM-Generated Results (Research Project <a href="/files/student_theses/Investigation_of_the_Explainability.pdf" target="_blank">[Slides (PDF)]</a>)  
...
- [7] Generation of a Knowledge Graph from Textual Data for Describing Causal System Behaviors (Master Thesis <a href="/files/student_theses/Generation_of_knowledge_graph.pdf" target="_blank">[Slides (PDF)]</a>)  
- [6] Training of General Neural Language Models for Automated Semantic Interpretation of Data Properties (Master Thesis <a href="/files/student_theses/Finetuning_of_general_neural_language_models.pdf" target="_blank">[Slides (PDF)]</a>) 
